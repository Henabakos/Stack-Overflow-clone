...
export function Header() {
  return (
    <header className="sticky top-0 z-50 lg:ml-64 lg:px-20 px-10 shadow-sm shadow-[#131722] bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
